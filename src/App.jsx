        ...
        <div className="hero-text">
          ...
          <div className="hero-actions fade-in fade-in-delay-4">
            <a
              ...
              href="mailto:babul.170126@s.pust.ac.bd"
            >
              ✉ Hire Me
            </a>
            <a
          ...
          <div className="hero-socials fade-in fade-in-delay-4">
            <a className="social-link" href="https://github.com/babulakter07" target="_blank" rel="noreferrer" title="GitHub">
            ...
            <a className="social-link" href="mailto:babul.170126@s.pust.ac.bd" title="Email">
              <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <div className="about-text">
            ...
            <div className="about-details">
              ...
              <div className="detail-row">
                ...
                <span className="detail-value">babul.170126@s.pust.ac.bd</span>
              </div>
              <div className="detail-row">
      ...
      <div className="container">
        ...
        <div className="online-judge-section">
          ...
          <div className="judge-platforms">
            {['LeetCode 500+', 'Codeforces', 'UVA', 'Toph.co', 'GeeksforGeeks', 'HackerRank'].map(p => (
              ...
              <div className="project-card-header">
                ...
                <div className="project-links">
                  <a
                    ...
                    href="https://github.com/babulakter07"
                    target="_blank"
                    rel="noreferrer"
                    title="GitHub"
                  >
...
function Contact() {
  ...
  const handleSubmit = e => {
    ...
    const mailtoLink = `mailto:babul.170126@s.pust.ac.bd?subject=${encodeURIComponent(subject || 'Portfolio Contact')}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\n${message}`)}`
        ...
        <div className="contact-grid">
          <div className="contact-info">
            ...
            <div className="contact-items">
              <div className="contact-item">
                ...
                <div className="contact-item-text">
                  <label>Email</label>
                  <a href="mailto:babul.170126@s.pust.ac.bd">babul.170126@s.pust.ac.bd</a>
                </div>
              </div>
              <div className="contact-item">
                <div className="contact-item-icon">📞</div>
            ...
            <div className="contact-socials">
              <a className="contact-social-btn" href="https://github.com/babulakter07" target="_blank" rel="noreferrer">
  ...
  return (
    <footer className="footer">
      ...
      <p style={{ marginTop: '8px', fontSize: '0.8rem' }}>
        <a href="https://github.com/babulakter07" target="_blank" rel="noreferrer" style={{ color: 'var(--text-muted)' }}>
          GitHub
        </a>
        {' · '}
